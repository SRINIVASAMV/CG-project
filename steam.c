...
void level()
{
	...
	glLoadName(TEXTID);
	DrawTextXY(-2.5,1.5,0.0,0.003,"animation of paper planes");
	...
	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.25,0.25,0.0,0.001,"     2: flying paper planes");
...
void first()
{
	...
	glLoadName(TEXTID);
	DrawTextXY(-2.7,1.05,0.0,0.0025,"COMPUTER GRARPHICS PROJECT");

	glColor3f(1.0,0.8,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.05,0.55,0.0,0.0025,"USING OPENGL");

	glColor3f(1.0,0.8,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.05,0.0,0.0,0.001,"  Press any key to continue.....!");

	glColor3f(1.0,0.8,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-2.5,-1.15,0.0,0.001,"Project by:   ATUL KUMAR               NANDINI H");

	glColor3f(1.0,0.8,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-2.5,-1.30,0.0,0.001,"USN:       1BY06CS007               1BY06CS031");
...
void help()
{
	...
	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-2.5,1.5,0.0,0.001,"to see output choose 2nd option in previous page ");
    DrawTextXY(-2.5,1.25,0.0,0.001,"after choosing 2 option right click to see menu ");
	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.85,0.75,0.0,0.001,"select any one of the options in menu");
	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.85,0.5,0.0,0.001,"if u select 'add plane' a paper plane will be added");
	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.85,0.25,0.0,0.001,"if u select 'remove plane' a paper plane will be deleted ");

	glColor3f(0.0,0.0,0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.85,0.0,0.0,0.001,"if u select 'motion' u can move planes   ");
	DrawTextXY(-1.85,-0.25,0.0,0.001,"if u select 'motion off' u can stop the movement of planes  ");
	DrawTextXY(-1.85,-0.50,0.0,0.001,"if u select 'quit' u can exit from program  ");
//	DrawTextXY(-1.85,-0.95,0.0,0.001,"if u press 'b' from keyboard u can go to previous page  ");
